...
const InstitutionalCollaboration = () => {
  return (
    <section className=" py-20 px-6 md:px-20 " style={{ fontFamily: "'Inter', sans-serif" }}>
      {/* Hero Quote */}
      <div className="max-w-5xl mx-auto mb-12 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-blue-900 leading-tight mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
          Let's Transform Your College
        </h1>
        <p className="text-lg md:text-xl font-medium text-gray-700" style={{ fontFamily: "'Inter', sans-serif" }}>
          INTO A CAMPUS OF CONFIDENCE, CREATIVITY, AND CAREER BUILDING.
        </p>
        <p className="mt-4 text-blue-800 font-semibold italic" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="text-center bg-gray-300 py-10 rounded-full">
        <h3 className="text-2xl font-semibold text-blue-800 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
